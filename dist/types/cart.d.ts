import { ICurrency, ILocaleSettings, ICustomer, ICheckoutStepper, ITotal, ICartTotal } from "boundless-api-client";
...
export interface CleanedCovaProduct extends Pick<CovaProduct, "ProductId" | "Slug" | "ClassificationId" | "ClassificationName" | "Name" | "ShortDescription" | "LongDescription" | "HeroShotUri" | "ProductSpecifications" | "Assets" | "Availability" | "Prices" | "discountedPrice" | "couponPrice" | "discount" | "UpdatedDateUtc"> {
}
